...
import { getBookingData, confirmBooking, BookingApiError } from '@/modules/calendar/services/booking-service';
import type { BookingDataResponse, BookingConfirmResponse, BookingErrorCode } from '@/modules/calendar/types/booking';
